...
export class RpcCore {
  ...
  _createMethodSend(section, method, def) {
    ...
    const callWithRegistry = async (isScale, values) => {
      ...
      const {
        registry
      } = isScale && blockHash && _classPrivateFieldLooseBase(this, _getBlockRegistry)[_getBlockRegistry] ? await _classPrivateFieldLooseBase(this, _getBlockRegistry)[_getBlockRegistry](u8aToU8a(blockHash)) : {
