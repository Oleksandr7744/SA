...
const infoMapping = {
  ...
  [_types.TypeDefInfo.Option]: (registry, value) => createWithSub(_typesCodec.Option, value),
  [_types.TypeDefInfo.Plain]: (registry, value) => registry.getOrUnknown(value.type),
  [_types.TypeDefInfo.Range]: (registry, value) => (value.type.includes('RangeInclusive') ? _typesCodec.RangeInclusive : _typesCodec.Range).with(getSubType(value)),
