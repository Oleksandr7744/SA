(function (global, factory) {
  ...
  (function (TypeDefInfo) {
    ...
    TypeDefInfo[TypeDefInfo["WrapperKeepOpaque"] = 20] = "WrapperKeepOpaque";
    TypeDefInfo[TypeDefInfo["WrapperOpaque"] = 21] = "WrapperOpaque";
  ...
  var _registry$1 = _classPrivateFieldKey("registry");
  var _raw$3 = _classPrivateFieldKey("raw");
  class Base {
    constructor(registry, value, initialU8aLength) {
      Object.defineProperty(this, _registry$1, {
        writable: true,
        value: void 0
      });
      this.createdAtHash = void 0;
      this.initialU8aLength = void 0;
      Object.defineProperty(this, _raw$3, {
        writable: true,
        value: void 0
      });
      _classPrivateFieldBase(this, _registry$1)[_registry$1] = registry;
      _classPrivateFieldBase(this, _raw$3)[_raw$3] = value;
      this.initialU8aLength = initialU8aLength;
    }
    get encodedLength() {
    ...
    get inner() {
      return _classPrivateFieldBase(this, _raw$3)[_raw$3];
    }
    get isEmpty() {
      return _classPrivateFieldBase(this, _raw$3)[_raw$3].isEmpty;
    }
    get registry() {
      return _classPrivateFieldBase(this, _registry$1)[_registry$1];
    }
    eq(other) {
      return _classPrivateFieldBase(this, _raw$3)[_raw$3].eq(other);
    }
    toHex(isLe) {
      return _classPrivateFieldBase(this, _raw$3)[_raw$3].toHex(isLe);
    }
    toHuman(isExtended) {
      return _classPrivateFieldBase(this, _raw$3)[_raw$3].toHuman(isExtended);
    }
    toJSON() {
      return _classPrivateFieldBase(this, _raw$3)[_raw$3].toJSON();
    }
    toString() {
      return _classPrivateFieldBase(this, _raw$3)[_raw$3].toString();
    }
    toU8a(isBare) {
      return _classPrivateFieldBase(this, _raw$3)[_raw$3].toU8a(isBare);
    }
    toRawType() {
      return 'Base';
    }
  ...
  var _Type$4 = _classPrivateFieldKey("Type");
  ...
  class Compact {
    constructor(registry, Type, value = 0) {
      ...
      this.registry = registry;
      _classPrivateFieldBase(this, _Type$4)[_Type$4] = typeToConstructor(registry, Type);
      const [raw, decodedLength] = Compact.decodeCompact(registry, _classPrivateFieldBase(this, _Type$4)[_Type$4], value);
      this.initialU8aLength = decodedLength;
      _classPrivateFieldBase(this, _raw$2)[_raw$2] = raw;
    }
    static with(Type) {
    ...
    static decodeCompact(registry, Type, value) {
      if (value instanceof Compact) {
        return [new Type(registry, _classPrivateFieldBase(value, _raw$2)[_raw$2]), 0];
    ...
    toBigInt() {
      return _classPrivateFieldBase(this, _raw$2)[_raw$2].toBigInt();
    }
    toBn() {
    ...
    toRawType() {
      return `Compact<${this.registry.getClassName(_classPrivateFieldBase(this, _Type$4)[_Type$4]) || _classPrivateFieldBase(this, _raw$2)[_raw$2].toRawType()}>`;
    }
    toString() {
      return _classPrivateFieldBase(this, _raw$2)[_raw$2].toString();
    }
    toU8a(isBare) {
      return util.compactToU8a(_classPrivateFieldBase(this, _raw$2)[_raw$2].toBn());
    }
    unwrap() {
  ...
  class Enum {
    constructor(registry, Types, value, index) {
      ...
      this.registry = registry;
      _classPrivateFieldBase(this, _def2)[_def2] = def;
      _classPrivateFieldBase(this, _isBasic)[_isBasic] = isBasic;
      _classPrivateFieldBase(this, _isIndexed)[_isIndexed] = isIndexed;
      _classPrivateFieldBase(this, _indexes)[_indexes] = Object.values(def).map(({
        index
      }) => index);
      ...
      if (_classPrivateFieldBase(this, _raw$1)[_raw$1].initialU8aLength) {
        this.initialU8aLength = 1 + _classPrivateFieldBase(this, _raw$1)[_raw$1].initialU8aLength;
      }
    }
    static with(Types) {
    ...
    toJSON() {
      return _classPrivateFieldBase(this, _isBasic)[_isBasic] ? this.type : {
        [util.stringCamelCase(this.type)]: _classPrivateFieldBase(this, _raw$1)[_raw$1].toJSON()
      };
    }
    toNumber() {
      return this.index;
    ...
    toU8a(isBare) {
      return util.u8aConcat(new Uint8Array(isBare ? [] : [this.index]), _classPrivateFieldBase(this, _raw$1)[_raw$1].toU8a(isBare));
    }
  }
  ...
  class Option {
    constructor(registry, typeName, value) {
      ...
      const decoded = util.isU8a(value) && value.length && !util.isCodec(value) ? value[0] === 0 ? new Null(registry) : new Type(registry, value.subarray(1)) : decodeOption(registry, Type, value);
      this.registry = registry;
      _classPrivateFieldBase(this, _Type$3)[_Type$3] = Type;
      _classPrivateFieldBase(this, _raw)[_raw] = decoded;
      if (decoded.initialU8aLength) {
        _classPrivateFieldBase(this, _initialU8aLength$1)[_initialU8aLength$1] = 1 + decoded.initialU8aLength;
      }
    }
    static with(Type) {
    ...
    toJSON() {
      return this.isNone ? null : _classPrivateFieldBase(this, _raw)[_raw].toJSON();
    }
    toRawType(isBare) {
      const wrapped = this.registry.getClassName(_classPrivateFieldBase(this, _Type$3)[_Type$3]) || new (_classPrivateFieldBase(this, _Type$3)[_Type$3])(this.registry).toRawType();
    ...
    unwrapOrDefault() {
      return this.isSome ? this.unwrap() : new (_classPrivateFieldBase(this, _Type$3)[_Type$3])(this.registry);
    }
  }
  ...
  var _Types$1 = _classPrivateFieldKey("Types");
  class Tuple extends AbstractArray {
    constructor(registry, Types, value) {
      ...
      Object.defineProperty(this, _Types$1, {
        writable: true,
        value: void 0
      });
      _classPrivateFieldBase(this, _Types$1)[_Types$1] = Classes;
    }
    static with(Types) {
    ...
    get Types() {
      return Array.isArray(_classPrivateFieldBase(this, _Types$1)[_Types$1]) ? _classPrivateFieldBase(this, _Types$1)[_Types$1].map(T => new T(this.registry).toRawType()) : Object.keys(_classPrivateFieldBase(this, _Types$1)[_Types$1]);
    }
    toRawType() {
      const types = (Array.isArray(_classPrivateFieldBase(this, _Types$1)[_Types$1]) ? _classPrivateFieldBase(this, _Types$1)[_Types$1] : Object.values(_classPrivateFieldBase(this, _Types$1)[_Types$1])).map(T => this.registry.getClassName(T) || new T(this.registry).toRawType());
      return `(${types.join(',')})`;
    }
    toString() {
    ...
    if (Array.isArray(value)) {
      ...
      for (let i = 0; i < value.length; i++) {
        ...
        try {
          ...
          l$4.error(`Unable to decode on index ${i}`, error.message);
          throw error;
        }
      }
      return [result, 0, 0];
  ...
  class Vec extends AbstractArray {
    constructor(registry, Type, value = []) {
      ...
      _classPrivateFieldBase(this, _Type$2)[_Type$2] = Clazz;
    }
    static with(Type) {
    ...
    get Type() {
      return _classPrivateFieldBase(this, _Type$2)[_Type$2].name;
    }
    indexOf(_other) {
      const other = _other instanceof _classPrivateFieldBase(this, _Type$2)[_Type$2] ? _other : new (_classPrivateFieldBase(this, _Type$2)[_Type$2])(this.registry, _other);
      for (let i = 0; i < this.length; i++) {
        if (other.eq(this[i])) {
          return i;
        }
    ...
    toRawType() {
      return `Vec<${this.registry.getClassName(_classPrivateFieldBase(this, _Type$2)[_Type$2]) || new (_classPrivateFieldBase(this, _Type$2)[_Type$2])(this.registry).toRawType()}>`;
    }
  }
  ...
  class VecFixed extends AbstractArray {
    ...
    get Type() {
      return new (_classPrivateFieldBase(this, _Type$1)[_Type$1])(this.registry).toRawType();
    }
    get encodedLength() {
      let total = 0;
      for (let i = 0; i < this.length; i++) {
  ...
  var _decodedLength = _classPrivateFieldKey("decodedLength");
  class BitVec extends Raw {
    constructor(registry, value) {
      ...
      _classPrivateFieldBase(this, _decodedLength)[_decodedLength] = decodedLength;
    }
    get encodedLength() {
      return this.length + util.compactToU8a(_classPrivateFieldBase(this, _decodedLength)[_decodedLength]).length;
    }
    toHuman() {
    ...
    toU8a(isBare) {
      ...
      return isBare ? bitVec : util.u8aConcat(util.compactToU8a(_classPrivateFieldBase(this, _decodedLength)[_decodedLength]), bitVec);
    }
  }
  ...
  class Struct extends Map {
    constructor(registry, Types, value, jsonMap = new Map()) {
      ...
      _classPrivateFieldBase(this, _registry)[_registry] = registry;
      this.initialU8aLength = decodedLength;
      _classPrivateFieldBase(this, _jsonMap)[_jsonMap] = jsonMap;
      _classPrivateFieldBase(this, _Types)[_Types] = typeMap;
    }
    ...
    toRawType() {
      return util.stringify(typesToMap(this.registry, _classPrivateFieldBase(this, _Types)[_Types]));
    }
    toString() {
      return util.stringify(this.toJSON());
    }
  ...
  const l$2 = util.logger('BTreeSet');
  ...
  function decodeSetFromSet(registry, ValClass, value) {
    ...
    value.forEach(val => {
      try {
        ...
        l$2.error('Failed to decode key or value:', error.message);
        throw error;
      }
    });
    return [output, 0];
  ...
  function decodeRaw$1(registry, typeName, value) {
    const Type = typeToConstructor(registry, typeName);
    if (util.isU8a(value) || util.isHex(value)) {
      try {
  ...
  var _Type = _classPrivateFieldKey("Type");
  var _decoded = _classPrivateFieldKey("decoded");
  class WrapperKeepOpaque extends Bytes {
    constructor(registry, typeName, value) {
      const [Type, decoded, u8a] = decodeRaw$1(registry, typeName, value);
      super(registry, u8a);
      Object.defineProperty(this, _Type, {
        writable: true,
        value: void 0
      ...
      _classPrivateFieldBase(this, _Type)[_Type] = Type;
      _classPrivateFieldBase(this, _decoded)[_decoded] = decoded;
    }
    static with(Type) {
    ...
    get isDecoded() {
      return !!_classPrivateFieldBase(this, _decoded)[_decoded];
    }
    toHuman(isExtended) {
      return _classPrivateFieldBase(this, _decoded)[_decoded] ? _classPrivateFieldBase(this, _decoded)[_decoded].toHuman(isExtended) : super.toHuman();
    }
    toRawType() {
      return `WrapperKeepOpaque<${this.registry.getClassName(_classPrivateFieldBase(this, _Type)[_Type]) || (_classPrivateFieldBase(this, _decoded)[_decoded] ? _classPrivateFieldBase(this, _decoded)[_decoded].toRawType() : new (_classPrivateFieldBase(this, _Type)[_Type])(this.registry).toRawType())}>`;
    }
    toString() {
      return _classPrivateFieldBase(this, _decoded)[_decoded] ? _classPrivateFieldBase(this, _decoded)[_decoded].toString() : super.toString();
    }
    unwrap() {
      return util.assertReturn(_classPrivateFieldBase(this, _decoded)[_decoded], 'WrapperKeepOpaque: unwrapping an undecodable value');
    }
  }
  ...
  const wrappedExtraction = [['BTreeSet<', '>', exports.TypeDefInfo.BTreeSet], ['Compact<', '>', exports.TypeDefInfo.Compact], ['Linkage<', '>', exports.TypeDefInfo.Linkage], ['Option<', '>', exports.TypeDefInfo.Option], ['Vec<', '>', exports.TypeDefInfo.Vec], ['WrapperKeepOpaque<', '>', exports.TypeDefInfo.WrapperKeepOpaque], ['WrapperOpaque<', '>', exports.TypeDefInfo.WrapperOpaque]];
  ...
  const definitions = /*#__PURE__*/Object.freeze({
    __proto__: null,
    assets: definitions$S,
    authorship: definitions$R,
    aura: definitions$Q,
    babe: definitions$P,
    balances: definitions$O,
    beefy: definitions$N,
    collective: definitions$M,
    consensus: definitions$L,
    contracts: definitions$K,
    democracy: definitions$J,
    ...
    state: definitions$1,
    metadata: definitions$V,
    runtime: definitions$U,
    scaleInfo: definitions$T
  });
  ...
  var _meta$1 = _classPrivateFieldKey("meta");
  var _method$1 = _classPrivateFieldKey("method");
  var _section$1 = _classPrivateFieldKey("section");
  ...
  class GenericEventData extends Tuple {
    constructor(registry, value, meta, section = '<unknown>', method = '<unknown>') {
      ...
      Object.defineProperty(this, _meta$1, {
        writable: true,
        value: void 0
      });
      Object.defineProperty(this, _method$1, {
        writable: true,
        value: void 0
      });
      ...
      _classPrivateFieldBase(this, _meta$1)[_meta$1] = meta;
      _classPrivateFieldBase(this, _method$1)[_method$1] = method;
      _classPrivateFieldBase(this, _section$1)[_section$1] = section;
      _classPrivateFieldBase(this, _typeDef)[_typeDef] = fields.map(({
        type
      }) => registry.lookup.getTypeDef(type));
    }
    get meta() {
      return _classPrivateFieldBase(this, _meta$1)[_meta$1];
    }
    get method() {
      return _classPrivateFieldBase(this, _method$1)[_method$1];
    }
    get section() {
      return _classPrivateFieldBase(this, _section$1)[_section$1];
    }
    get typeDef() {
  ...
  class GenericExtrinsic extends ExtrinsicBase {
    ...
    toU8a(isBare) {
      const encoded = util.u8aConcat(new Uint8Array([this.version]), this.inner.toU8a());
      return isBare ? encoded : util.compactAddLength(encoded);
    }
  }
  ...
  var _extraTypes = _classPrivateFieldKey("extraTypes");
  class GenericSignerPayload extends Struct {
    constructor(registry, value) {
      ...
      _classPrivateFieldBase(this, _extraTypes)[_extraTypes] = {};
      const getter = key => this.get(key);
      for (const [key, type] of Object.entries(extensionTypes)) {
        if (!knownTypes[key]) {
          _classPrivateFieldBase(this, _extraTypes)[_extraTypes][key] = type;
        }
    ...
    toPayload() {
      const result = {};
      const keys = Object.keys(_classPrivateFieldBase(this, _extraTypes)[_extraTypes]);
      for (let i = 0; i < keys.length; i++) {
        const key = keys[i];
  ...
  class GenericExtrinsicSignatureV4 extends Struct {
    constructor(registry, value, {
      ...
      util.objectProperties(this, _classPrivateFieldBase(this, _signKeys)[_signKeys], k => this.get(k));
    }
  ...
  var _aye = _classPrivateFieldKey("aye");
  var _conviction = _classPrivateFieldKey("conviction");
  class GenericVote extends U8aFixed {
    constructor(registry, value) {
      ...
      _classPrivateFieldBase(this, _aye)[_aye] = (decoded[0] & AYE_BITS) === AYE_BITS;
      _classPrivateFieldBase(this, _conviction)[_conviction] = this.registry.createTypeUnsafe('Conviction', [decoded[0] & CON_MASK]);
    }
    get conviction() {
      return _classPrivateFieldBase(this, _conviction)[_conviction];
    }
    get isAye() {
      return _classPrivateFieldBase(this, _aye)[_aye];
    }
    get isNay() {
      return !this.isAye;
    }
  ...
  function decodeHashers(registry, value, hashers) {
    ...
    for (let i = 0; i < hashers.length; i++) {
      ...
      const decoded = canDecode ? registry.createTypeUnsafe(registry.createLookupType(type), [value.subarray(offset + hashLen)]) : registry.createTypeUnsafe('Raw', [value.subarray(offset, offset + hashLen)]);
  ...
  var _args = _classPrivateFieldKey("args");
  var _meta = _classPrivateFieldKey("meta");
  var _outputType = _classPrivateFieldKey("outputType");
  ...
  class StorageKey extends Bytes {
    constructor(registry, value, override = {}) {
      ...
      _classPrivateFieldBase(this, _outputType)[_outputType] = getType(registry, value);
      this.setMeta(getMeta(value), override.section || section, override.method || method);
    }
    get args() {
      return _classPrivateFieldBase(this, _args)[_args];
    }
    get meta() {
    ...
    get outputType() {
      return _classPrivateFieldBase(this, _outputType)[_outputType];
    }
    get section() {
    ...
    setMeta(meta, section, method) {
      ...
      _classPrivateFieldBase(this, _method)[_method] = method || _classPrivateFieldBase(this, _method)[_method];
      _classPrivateFieldBase(this, _section)[_section] = section || _classPrivateFieldBase(this, _section)[_section];
      if (meta) {
        _classPrivateFieldBase(this, _outputType)[_outputType] = unwrapStorageType(this.registry, meta.type);
      }
      try {
        _classPrivateFieldBase(this, _args)[_args] = decodeArgsFromMeta(this.registry, this.toU8a(true), meta);
      } catch (error) {
      }
      return this;
    }
    toHuman() {
      return _classPrivateFieldBase(this, _args)[_args].length ? _classPrivateFieldBase(this, _args)[_args].map(a => a.toHuman()) : super.toHuman();
    }
    toRawType() {
      return 'StorageKey';
    }
  ...
  function toV14(registry, v13, metaVersion) {
    ...
    return registry.createTypeUnsafe('MetadataV14', [{
      extrinsic,
      lookup: {
        types: compatTypes.map((type, id) => registry.createTypeUnsafe('PortableType', [{
          id,
          type
        }]))
      },
  ...
  function createKeyRaw(registry, itemFn, {
    ...
    return util.u8aConcat(utilCrypto.xxhashAsU8a(itemFn.prefix, 128), utilCrypto.xxhashAsU8a(itemFn.method, 128), ...extra);
  }
  ...
  function createKey(registry, itemFn, {
    ...
    return util.compactAddLength(createKeyRaw(registry, itemFn, {
      args,
      hashers,
      keys
    }));
  ...
  function extendHeadMeta(registry, {
    ...
    iterFn.meta = registry.createTypeUnsafe('StorageEntryMetadataLatest', [{
      docs,
    ...
    return (...args) => registry.createTypeUnsafe('StorageKey', [iterFn(...args), {
      method,
      section
    }]);
  }
  ...
  '*_runtime_*::Call', '*_runtime_*::Event',
  ...
  class PortableRegistry extends Struct {
    constructor(registry, value) {
      ...
      registerTypes(this, lookups, names, _params);
    }
    get names() {
  ...
  class TypeRegistry {
    constructor(createdAtHash) {
      ...
      this.createdAtHash = void 0;
      _classPrivateFieldBase(this, _knownDefaults)[_knownDefaults] = util.objectSpread({
        Json,
        Metadata,
        PortableRegistry,
        Raw
    ...
    findMetaCall(callIndex) {
      ...
      return util.assertReturn(_classPrivateFieldBase(this, _metadataCalls)[_metadataCalls][`${section}`] && _classPrivateFieldBase(this, _metadataCalls)[_metadataCalls][`${section}`][`${method}`], () => `findMetaCall: Unable to find Call with index [${section}, ${method}]/[${callIndex.toString()}]`);
    }
    findMetaError(errorIndex) {
      const [section, method] = util.isU8a(errorIndex) ? [errorIndex[0], errorIndex[1]] : [errorIndex.index.toNumber(), errorIndex.error.toNumber()];
      return util.assertReturn(_classPrivateFieldBase(this, _metadataErrors)[_metadataErrors][`${section}`] && _classPrivateFieldBase(this, _metadataErrors)[_metadataErrors][`${section}`][`${method}`], () => `findMetaError: Unable to find Error with index [${section}, ${method}]/[${errorIndex.toString()}]`);
    }
    findMetaEvent(eventIndex) {
      const [section, method] = [eventIndex[0], eventIndex[1]];
      return util.assertReturn(_classPrivateFieldBase(this, _metadataEvents)[_metadataEvents][`${section}`] && _classPrivateFieldBase(this, _metadataEvents)[_metadataEvents][`${section}`][`${method}`], () => `findMetaEvent: Unable to find Event with index [${section}, ${method}]/[${eventIndex.toString()}]`);
    }
    ...
    setMetadata(metadata, signedExtensions, userExtensions) {
      ...
      this.setSignedExtensions(signedExtensions || (_classPrivateFieldBase(this, _metadata)[_metadata].extrinsic.version.gt(util.BN_ZERO)
  ...
  const packageInfo = {
    name: '@polkadot/types',
    path: new URL('.', (typeof document === 'undefined' && typeof location === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.src || new URL('bundle-polkadot-types.js', document.baseURI).href))).pathname,
    type: 'esm',
    version: '7.4.1'
  };
