...
var _extraTypes = /*#__PURE__*/_classPrivateFieldLooseKey("extraTypes");
...
export class GenericSignerPayload extends Struct {
  constructor(registry, value) {
    ...
    _classPrivateFieldLooseBase(this, _extraTypes)[_extraTypes] = {};
    ...
    for (const [key, type] of Object.entries(extensionTypes)) {
      if (!knownTypes[key]) {
        _classPrivateFieldLooseBase(this, _extraTypes)[_extraTypes][key] = type;
      }
  ...
  toPayload() {
    const result = {};
    const keys = Object.keys(_classPrivateFieldLooseBase(this, _extraTypes)[_extraTypes]); // add any explicit overrides we may have
