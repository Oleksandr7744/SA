...
var _lookup = /*#__PURE__*/_classPrivateFieldLooseKey("lookup");

var _metadata = /*#__PURE__*/_classPrivateFieldLooseKey("metadata");

var _metadataVersion = /*#__PURE__*/_classPrivateFieldLooseKey("metadataVersion");
...
export class TypeRegistry {
  constructor(createdAtHash) {
    ...
    _classPrivateFieldLooseBase(this, _knownDefaults)[_knownDefaults] = objectSpread({
      Json,
      Metadata,
      PortableRegistry,
      Raw
  ...
  init() {
    ...
    const allKnown = Object.values(_classPrivateFieldLooseBase(this, _knownDefinitions)[_knownDefinitions]);
  ...
  get lookup() {
    return _classPrivateFieldLooseBase(this, _lookup)[_lookup] || this.metadata.lookup;
  }
  ...
  findMetaCall(callIndex) {
    ...
    return assertReturn(_classPrivateFieldLooseBase(this, _metadataCalls)[_metadataCalls][`${section}`] && _classPrivateFieldLooseBase(this, _metadataCalls)[_metadataCalls][`${section}`][`${method}`], () => `findMetaCall: Unable to find Call with index [${section}, ${method}]/[${callIndex.toString()}]`);
  } // finds an error


  findMetaError(errorIndex) {
    const [section, method] = isU8a(errorIndex) ? [errorIndex[0], errorIndex[1]] : [errorIndex.index.toNumber(), errorIndex.error.toNumber()];
    return assertReturn(_classPrivateFieldLooseBase(this, _metadataErrors)[_metadataErrors][`${section}`] && _classPrivateFieldLooseBase(this, _metadataErrors)[_metadataErrors][`${section}`][`${method}`], () => `findMetaError: Unable to find Error with index [${section}, ${method}]/[${errorIndex.toString()}]`);
  }

  findMetaEvent(eventIndex) {
    const [section, method] = [eventIndex[0], eventIndex[1]];
    return assertReturn(_classPrivateFieldLooseBase(this, _metadataEvents)[_metadataEvents][`${section}`] && _classPrivateFieldLooseBase(this, _metadataEvents)[_metadataEvents][`${section}`][`${method}`], () => `findMetaEvent: Unable to find Event with index [${section}, ${method}]/[${eventIndex.toString()}]`);
  }
  ...
  getClassName(Type) {
    ...
    for (const [name, Clazz] of _classPrivateFieldLooseBase(this, _classes)[_classes].entries()) {
      if (Type === Clazz) {
        names.push(name);
      }
  ...
  setLookup(lookup) {
    _classPrivateFieldLooseBase(this, _lookup)[_lookup] = lookup;
  } // sets the metadata
  ...
  setMetadata(metadata, signedExtensions, userExtensions) {
    ...
    _classPrivateFieldLooseBase(this, _metadataVersion)[_metadataVersion] = metadata.version;
    injectExtrinsics(this, _classPrivateFieldLooseBase(this, _metadata)[_metadata], _classPrivateFieldLooseBase(this, _metadataVersion)[_metadataVersion], _classPrivateFieldLooseBase(this, _metadataCalls)[_metadataCalls]);
    injectErrors(this, _classPrivateFieldLooseBase(this, _metadata)[_metadata], _classPrivateFieldLooseBase(this, _metadataVersion)[_metadataVersion], _classPrivateFieldLooseBase(this, _metadataErrors)[_metadataErrors]);
    injectEvents(this, _classPrivateFieldLooseBase(this, _metadata)[_metadata], _classPrivateFieldLooseBase(this, _metadataVersion)[_metadataVersion], _classPrivateFieldLooseBase(this, _metadataEvents)[_metadataEvents]); // setup the available extensions

    this.setSignedExtensions(signedExtensions || (_classPrivateFieldLooseBase(this, _metadata)[_metadata].extrinsic.version.gt(BN_ZERO) // FIXME Use the extension and their injected types
    ? _classPrivateFieldLooseBase(this, _metadata)[_metadata].extrinsic.signedExtensions.map(({
      identifier
