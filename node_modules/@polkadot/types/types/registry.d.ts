...
export declare type CodecHasher = (data: Uint8Array) => Uint8Array;
...
export declare type DeriveCustom = Record<string, Record<string, (instanceId: string, api: any) => (...args: any[]) => Observable<any>>>;
export declare type AliasDefinition = Record<string, OverrideModuleType>;
