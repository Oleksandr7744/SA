import type { AnyJson, Codec, CodecRegistry } from '@polkadot/types-codec/types';
...
export declare class GenericEventData extends Tuple implements IEventData {
    #private;
    constructor(registry: CodecRegistry, value: Uint8Array, meta: EventMetadataLatest, section?: string, method?: string);
    /**
