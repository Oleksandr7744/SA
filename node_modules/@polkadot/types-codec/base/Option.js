...
var _initialU8aLength = /*#__PURE__*/_classPrivateFieldLooseKey("initialU8aLength");
...
export class Option {
  constructor(registry, typeName, value) {
    ...
    const decoded = isU8a(value) && value.length && !isCodec(value) ? value[0] === 0 ? new Null(registry) : new Type(registry, value.subarray(1)) : decodeOption(registry, Type, value);
    this.registry = registry;
    _classPrivateFieldLooseBase(this, _Type)[_Type] = Type;
    _classPrivateFieldLooseBase(this, _raw)[_raw] = decoded;

    if (decoded.initialU8aLength) {
      _classPrivateFieldLooseBase(this, _initialU8aLength)[_initialU8aLength] = 1 + decoded.initialU8aLength;
    }
  }
  ...
  get initialU8aLength() {
    return _classPrivateFieldLooseBase(this, _initialU8aLength)[_initialU8aLength];
  }
  /**
