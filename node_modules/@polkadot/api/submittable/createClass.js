...
export function createClass({
  ...
  class Submittable extends ExtrinsicBase {
    constructor(registry, extrinsic) {
      ...
      Object.defineProperty(this, _observeSubscribe, {
        ...
        value: (updateId = -1) => {
          ...
          return api.rpc.author.submitAndWatchExtrinsic(this).pipe(switchMap(status => _classPrivateFieldLooseBase(this, _observeStatus)[_observeStatus](txHash, status)), tap(status => {
    ...
    signAsync(account, partialOptions) {
      // eslint-disable-next-line @typescript-eslint/no-unsafe-return,@typescript-eslint/no-unsafe-call
      return decorateMethod(() => _classPrivateFieldLooseBase(this, _observeSign)[_observeSign](account, partialOptions).pipe(mapTo(this)))();
