(function (global, factory) {
        ...
        value: response => {
          ...
          try {
            ...
            if (subscription) {
              ...
              _classPrivateFieldBase(this, _subscriptions$1)[_subscriptions$1][subId] = util.objectSpread({}, subscription, {
                method,
                params
              });
  ...
  ***************************************************************************** */
    ...
    _createMethodSubscribe(section, method, def) {
      ...
      const creator = isScale => (...values) => {
        return new Observable(observer => {
          ...
          return () => {
            var _memoized2;
            (_memoized2 = memoized) === null || _memoized2 === void 0 ? void 0 : _memoized2.unmemoize(...values);
  ...
  function queryCurrent(api, accountId, balanceInstances = ['balances']) {
    ...
    return ((_api$query$vesting = api.query.vesting) !== null && _api$query$vesting !== void 0 && _api$query$vesting.vesting ? api.queryMulti([[api.query.vesting.vesting, accountId], ...queries])
  ...
  function combineEras(fn) {
    return (instanceId, api) =>
    memo(instanceId, (eras, withActive) =>
      ...
      constructor(registry, extrinsic) {
        ...
        Object.defineProperty(this, _observeSubscribe, {
          ...
          value: (updateId = -1) => {
            ...
            return api.rpc.author.submitAndWatchExtrinsic(this).pipe(switchMap(status => _classPrivateFieldBase(this, _observeStatus)[_observeStatus](txHash, status)), tap(status => {
