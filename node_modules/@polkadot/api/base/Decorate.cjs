...
class Decorate extends _Events.Events {
  ...
  _decorateStorageEntry(creator, decorateMethod) {
    ...
    if (creator.iterKey && creator.meta.type.isMap) {
      ...
      decorated.entriesAt = decorateMethod((0, _rpcCore.memo)((0, _classPrivateFieldLooseBase2.default)(this, _instanceId)[_instanceId], function (blockHash) {
      ...
      decorated.keysAt = decorateMethod((0, _rpcCore.memo)((0, _classPrivateFieldLooseBase2.default)(this, _instanceId)[_instanceId], function (blockHash) {
  ...
  _decorateStorageCall(creator, decorateMethod) {
    ...
    return decorateMethod(function () {
      ...
      return _this3.hasSubscriptions ? _this3._rpcCore.state.subscribeStorage([(0, _validate.extractStorageArgs)((0, _classPrivateFieldLooseBase2.default)(_this3, _registry)[_registry], creator, args)]).pipe((0, _rxjs.map)(_ref4 => {
        let [data] = _ref4;
        return data;
